...
import { View, Image, Text, StyleSheet, ScrollView, Linking, FlatList } from 'react-native';
...
const PlantSales = () => {
    ...
    const data = [
        ...
        },
        {
          ...
          content: (
            <>
              <Text style={styles.justifyText}>Current prices for our Native Plant Sales are shown below. Prices include GST.{"\n"}</Text>
      ...
      
        {
            ...
            content: (<Text>You can pay by card (not AMEX) or cheque. Cash is not accepted.{"\n"}{"\n"}Bring your current rates notice as proof that you’re a resident of the Wollongong City Council area to buy plants at these sales</Text>),
        },
        {
          title: "Locations",
          content: (
            <>
              <Text style={styles.justifyText}>Our plants are available at the following locations:{"\n"}</Text>
              <Text style={styles.justifyText}>1. Botanic Garden Nursery</Text>
              <Text style={styles.justifyText}>2. Central Park Greenhouse</Text>
              <Text style={styles.justifyText}>3. Riverside Plant Store</Text>
            </>
          )
        },
        {
          title: "Bring back your pots",
          content: (
            <>
        ...
        {
          title: "Plants for schools and community organizations",
          content: (
            <>
              <Text style={styles.justifyText}>{"\n"}
...
const styles = StyleSheet.create({
  ...
  cellText: {
    ...
    height: 70, // Adjust the height of the cell
